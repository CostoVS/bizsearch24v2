    ...
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter">
                NEWS <span className="text-emerald-500">PULSE</span>
              </h1>
              <p className="text-slate-400 max-w-xl text-lg font-medium">
                AI-curated business and general news summaries from South Africa and the world. Updated hourly.
              </p>
            </div>
      ...
      <div className="max-w-6xl mx-auto -mt-8 px-6 pb-20">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-6 md:p-8">
          ...
          {/* Disclaimer */}
          <div className="flex items-start gap-4 p-4 bg-amber-50 rounded-2xl border border-amber-100 mb-10">
            <div className="bg-amber-100 p-2 rounded-xl">
              <ShieldCheck className="w-5 h-5 text-amber-600" />
            </div>
            <div className="text-xs text-amber-900 font-medium leading-relaxed">
              <span className="font-black uppercase text-amber-700">Fair Use & Transparency:</span> These summaries are generated by AI from respected news sources. We respect intellectual property and provide direct links to the full articles for further reading.
            </div>
          </div>
